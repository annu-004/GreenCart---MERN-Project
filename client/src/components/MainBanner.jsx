...
const MainBanner = () => {
  return (
    <div className='relative'>
        ...
        <div className='absolute inset-0 flex flex-col items-center md:items-start justfy-end
        ...
        <div className='flex items-center mt-6 font-medium'>
            ...
            cursor-pointer'>
            Explore deals
            <img className='tranition group-hover:translate-x-1' src={assets.black_arrow_icon} alt="arrow" />
            </Link>
        </div>
        </div>
    </div>
