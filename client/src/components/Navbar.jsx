...
<div className='flex items-center gap-6 sm:hidden'>
            ...
            { open && ( 
                ...
                <NavLink to='/' on onClick={()=>setOpen(false)}>Home</NavLink>
                <NavLink to='/products' on onClick={()=>setOpen(false)}>All Product</NavLink>
                {user &&
                <NavLink to='/products' on onClick={()=>setOpen(false)}>My Order</NavLink>
                }
                <NavLink to='/' on onClick={()=>setOpen(false)}>Contact</NavLink>
